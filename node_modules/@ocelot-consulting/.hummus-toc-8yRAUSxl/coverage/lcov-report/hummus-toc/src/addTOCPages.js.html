...
<html lang="en">
<head>
    <title>Code coverage report for hummus-toc/src/addTOCPages.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">hummus-toc/src</a> addTOCPages.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">3x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const {verticalMax, horizontalMax, verticalMargin, leftMarginEnd, lineSpacing, fontPath} = require('../config')
&nbsp;
