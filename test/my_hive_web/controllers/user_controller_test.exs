defmodule MyHiveWeb.UserControllerTest do
  use MyHiveWeb.ConnCase

  alias MyHive.Accounts

  @create_attrs %{email: "some email", encrypted_password: "some encrypted_password", first_name: "some first_name", is_active: true, last_name: "some last_name", phone_number: "some phone_number"}
